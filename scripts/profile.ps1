...
#Get-ADDevice - function to retrieve msds-device objects from Active Directory
#Author: Shane Wright
#
#get-adDevice retrieves devices from AD
#get-ADDeviceContainer searches the forest for the Device Registration container
